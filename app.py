...
# Gunakan 3 kolom: kiri kosong, tengah judul, kanan logo
...
with col2:
    st.markdown(
        ...
        <div style="
            ...
            <p style="margin:0; font-size:16px; line-height:1.2; color:white;">
...
with col3:
    st.image(logo, width=100)  # logo besar, di kanan
